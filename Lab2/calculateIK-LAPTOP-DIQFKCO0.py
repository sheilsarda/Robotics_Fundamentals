...
class Main():
    ...
    def __init__(self):
        """
        This is the dimension of the Lynx Robot stated as global variable s
    ...
    def inverse(self, T0e):
        ...
        theta3_2 = -np.pi/2 -np.arccos((wrist_pos[0]**2 + wrist_pos[1]**2 + (wrist_pos[2] - self.d1)**2 - self.a2**2 - self.a3**2) / (2*self.a2*self.a3))
        #q = np.concatenate((q, new_row))
