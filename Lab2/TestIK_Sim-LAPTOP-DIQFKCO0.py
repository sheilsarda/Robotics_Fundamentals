...
# Target 3-- not feasible, loops infinitely
...
# Target 4-- not feasible
# T0e = np.array([[  0.5054096, -0.8370580, -0.2095115, -45],[-0.0305796,  0.2252773, -0.9738147,-300],[0.8623375,  0.4985821,  0.0882604, 63 ],[0,0,0,1]])

# Added by us to test our implementation further; not part of Lab 2
# Zero configuration with Roll 
# T0e = np.array([[  1, 0, 0, 225.325],[0, np.cos(np.pi/2), -np.sin(np.pi/2), 0],[0, np.sin(np.pi/2), np.cos(np.pi/2), 222.25],[0,0,0,1]])
